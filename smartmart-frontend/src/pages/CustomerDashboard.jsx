...
function CustomerDashboard() {
  ...
  const API_URL =
    "https://smartmart-w2gb.onrender.com";
  ...
  const fetchCustomerData = async () => {
    try {
      ...
      console.log(
        "Fetching dashboard for user ID:",
        userId
      );
  ...
  const getCustomerName = () => {
    ...
    // Your User entity may use fullName
                ...
                <div className="bg-white rounded-2xl border border-gray-200 mt-8 overflow-hidden">
                  ...
                  <div className="p-6 flex items-center justify-between border-b border-gray-200">
                    ...
                    <button
                      ...
                      className="hidden sm:flex items-center gap-1 text-blue-600 font-medium text-sm"
                    >
                      View All
                      <ChevronRight
                        size={17}
